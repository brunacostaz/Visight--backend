...
valor_alimento = verificar_num('Qual o valor pago por esse alimento?\n-> ')
...
print(f'\nAnálise de dados\n\nRendimento: {rendimento:.2f}%\nPrejuízo: {prejuizo:.2f}%\nDesperdício: {desperdicio:.2f} - equivalente a {percentual_desperdicio:.2f}%')
